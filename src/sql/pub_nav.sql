...
CREATE TABLE `pub_nav` (
  ...
  `is_category` tinyint(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT '是否分类导航',
  `flag` varchar(50) NOT NULL COMMENT '标记',
  `label` varchar(50) NOT NULL COMMENT '显示标签',
  `url` varchar(50) NOT NULL DEFAULT '' COMMENT '导航url',
  ...
  `is_blank` tinyint(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT '是否新开窗口',
