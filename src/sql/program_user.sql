...
--
INSERT INTO `program_user` (`uid`, `username`, `password`, `nickname`, `real_name`, `sex`, `birthday`, `avatar`, `mobile`, `phone`, `qq`, `address`, `zip_code`, `refer_uid`, `register_ip`, `login_times`, `last_login_ip`, `last_login_at`, `is_super`, `is_enable`) VALUES
