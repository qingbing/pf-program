...
CREATE TABLE IF NOT EXISTS `program_user` (
  ...
  `username` varchar(20) NOT NULL COMMENT '邮箱账户',
  ...
  `is_super` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否超级程序员',
...
--
INSERT INTO `program_user` (`uid`, `username`, `password`, `nickname`, `real_name`, `sex`, `birthday`, `avatar`, `mobile`, `phone`, `qq`, `address`, `zip_code`, `refer_uid`, `register_ip`, `register_time`, `login_times`, `last_login_ip`, `last_login_time`, `is_super`, `is_enable`) VALUES
('1', 'top-world@qq.com', '9db06bcff9248837f86d1a6bcf41c9e7', 'Charles', '超级程序员', '1', NULL, '', '', '', '', '', '', '0', '127.0.0.1', '2017-08-21 00:09:42', '1', '192.168.146.1', '2017-08-21 08:15:01', '1', '1');
